...
func TestOOIRootImageDecode(t *testing.T) {
  ...
  resp,err := http.Get("http://127.0.0.1:8080/v1/org/oceanobservatories/rawdata/files/RS03ASHS/PN03B/06-CAMHDA301/2016/07/24/CAMHDA301-20160724T030000Z.mov/frame/1000")
  defer resp.Body.Close()
